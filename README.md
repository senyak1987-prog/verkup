...
В правой панели приложения нажмите `Редактировать справочник`. В редакторе можно выбрать позицию из списка, изменить раздел, название, единицу, цену и источник, добавить новую позицию или удалить существующую.
